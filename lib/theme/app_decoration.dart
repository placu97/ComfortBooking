...
class AppDecoration {
  ...
  static BoxDecoration get gradientGray80000Bluegray90002 => BoxDecoration(
  ...
  static BoxDecoration get txtOutlineCyan600 => BoxDecoration(
        border: Border.all(
          color: ColorConstant.cyan600,
          width: getHorizontalSize(
            2.00,
  ...
  static BoxDecoration get txtFillRedA20033 => BoxDecoration(
        color: ColorConstant.redA20033,
      );
  ...
  static BoxDecoration get txtFillGreen40033 => BoxDecoration(
        color: ColorConstant.green40033,
      );
  ...
  static BoxDecoration get outlineCyan6001 => BoxDecoration(
        border: Border.all(
          color: ColorConstant.cyan600,
          width: getHorizontalSize(
            3.00,
